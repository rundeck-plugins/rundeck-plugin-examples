...
class ExampleRemoteScriptNodeStepPlugin implements RemoteScriptNodeStepPlugin, DescriptionBuilder.Collaborator {
    /**
     ...
     */
    void buildWith(final DescriptionBuilder builder) {
        ...
        builder.property(
            ...
            builder.property("money")
                ...
                .validator(new PropertyValidator() {
                    boolean isValid(String s) throws ValidationException {
                        try {
     ...
     */
    GeneratedScript generateScript(final PluginStepContext context,
